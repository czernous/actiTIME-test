...
},{}],"../node_modules/core-js-pure/internals/to-integer.js":[function(require,module,exports) {
var ceil = Math.ceil;
...
},{}],"../node_modules/core-js-pure/internals/require-object-coercible.js":[function(require,module,exports) {
...
},{"../internals/to-integer":"../node_modules/core-js-pure/internals/to-integer.js","../internals/require-object-coercible":"../node_modules/core-js-pure/internals/require-object-coercible.js"}],"../node_modules/core-js-pure/internals/global.js":[function(require,module,exports) {
...
},{"../internals/fails":"../node_modules/core-js-pure/internals/fails.js","../internals/classof-raw":"../node_modules/core-js-pure/internals/classof-raw.js"}],"../node_modules/core-js-pure/internals/to-indexed-object.js":[function(require,module,exports) {
...
},{"../internals/indexed-object":"../node_modules/core-js-pure/internals/indexed-object.js","../internals/require-object-coercible":"../node_modules/core-js-pure/internals/require-object-coercible.js"}],"../node_modules/core-js-pure/internals/object-get-own-property-descriptor.js":[function(require,module,exports) {
var DESCRIPTORS = require('../internals/descriptors');
...
},{"../core-js/promise":"../node_modules/@babel/runtime-corejs3/core-js/promise.js"}],"../node_modules/core-js-pure/internals/is-array.js":[function(require,module,exports) {
var classof = require('../internals/classof-raw');
...
},{"../internals/classof-raw":"../node_modules/core-js-pure/internals/classof-raw.js"}],"../node_modules/core-js-pure/internals/create-property.js":[function(require,module,exports) {
'use strict';
var toPrimitive = require('../internals/to-primitive');
var definePropertyModule = require('../internals/object-define-property');
var createPropertyDescriptor = require('../internals/create-property-descriptor');
...
},{"core-js-pure/stable/instance/concat":"../node_modules/core-js-pure/stable/instance/concat.js"}],"../src/components/Header.js":[function(require,module,exports) {
"use strict";
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            ...
            template.innerHTML = (0, _concat.default)(_context = (0, _concat.default)(_context2 = "\n  ".concat((0, _Header.default)(), "\n  ")).call(_context2, (0, _Content.default)(), "\n  ")).call(_context, (0, _Footer.default)(), "\n"); // Return a new node from template
...
var _default = App;
exports.default = _default;
},{"@babel/runtime-corejs3/regenerator":"../node_modules/@babel/runtime-corejs3/regenerator/index.js","@babel/runtime-corejs3/core-js-stable/instance/concat":"../node_modules/@babel/runtime-corejs3/core-js-stable/instance/concat.js","@babel/runtime-corejs3/helpers/asyncToGenerator":"../node_modules/@babel/runtime-corejs3/helpers/asyncToGenerator.js","./components/Header":"../src/components/Header.js","./components/Content":"../src/components/Content.js","./components/Footer":"../src/components/Footer.js"}],"../node_modules/core-js-pure/modules/web.timers.js":[function(require,module,exports) {
...
},{"core-js-pure/stable/set-timeout":"../node_modules/core-js-pure/stable/set-timeout.js"}],"../node_modules/core-js-pure/internals/array-iteration.js":[function(require,module,exports) {
var bind = require('../internals/function-bind-context');
var IndexedObject = require('../internals/indexed-object');
var toObject = require('../internals/to-object');
var toLength = require('../internals/to-length');
...
},{"core-js-pure/stable/instance/for-each":"../node_modules/core-js-pure/stable/instance/for-each.js"}],"../src/navbar.js":[function(require,module,exports) {
"use strict";
...
function dropdownToggle() {
  return _dropdownToggle.apply(this, arguments);
}

function _dropdownToggle() {
  _dropdownToggle = (0, _asyncToGenerator2.default)( /*#__PURE__*/_regenerator.default.mark(function _callee() {
    var dropdownLink, dropdownMenu, hamburger, mobileNav;
    return _regenerator.default.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            dropdownLink = document.querySelectorAll('.dropdown');
            dropdownMenu = document.querySelectorAll('.dropdown__menu');
            hamburger = document.querySelector('.btn--hamburger');
            ...
            (0, _forEach.default)(dropdownLink).call(dropdownLink, function (link) {
              link.addEventListener('mouseenter', function (e) {
                e.stopPropagation();
                (0, _forEach.default)(dropdownMenu).call(dropdownMenu, function (menu) {
...
},{"core-js-pure/stable/instance/map":"../node_modules/core-js-pure/stable/instance/map.js"}],"../src/carousel.js":[function(require,module,exports) {
"use strict";
...
function _carousel() {
  _carousel = (0, _asyncToGenerator2.default)( /*#__PURE__*/_regenerator.default.mark(function _callee() {
    var bannerNew, cardsContent, displaySlideInfo, showSlides;
    return _regenerator.default.wrap(function _callee$(_context4) {
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            bannerNew = "<span class=\"card__ribbon\">NEW</span>";
            cardsContent = [{
              id: 1,
              heading: 'First',
              ...
              description: "Little Red Cap opened her eyes and when she saw the sunbeams dancing to and fro through the\n                  trees and how the ground was covered with beautiful flowers.",
              link: '#',
              banner: "".concat(bannerNew)
            }];

            displaySlideInfo = function displaySlideInfo(slideInfo) {
              var slideContainer = document.querySelector('.features__slide-container');
              var displaySlide = (0, _map.default)(slideInfo).call(slideInfo, function (item) {
                var _context, _context2, _context3;

                return (0, _concat.default)(_context = (0, _concat.default)(_context2 = (0, _concat.default)(_context3 = "\n          <div class=\"features__slide\">\n            <div class=\"features__card\">\n            <p class=\"card__heading\">".concat(item.heading, " Feature</p>\n            <p class=\"card__description\">")).call(_context3, item.description, "</p>\n            <a href=\"#\" class=\"card__link\">Learn more</a>\n            <span class=\"card__number\">")).call(_context2, item.id, "</span>\n            ")).call(_context, item.banner, "\n            </div>\n            </div>");
              });
            ...
            showSlides = function showSlides() {
              var dots = document.querySelectorAll('.indicator__dot');
              var slideContainer = document.querySelector('.features__slide-container');
              ...
              var _loop = function _loop(i) {
                (function (index) {
                  dots[i].onclick = function (e) {
                    e.preventDefault();
                    (0, _forEach.default)(dots).call(dots, function (dot) {
                      dot.classList.remove('is-active');
                    });
                    e.target.classList.add('is-active');
                    var num = 81.2;
                    index === 3 ? num += 15.5 : index === 2 ? num += 12.5 : num === num;
                    index !== 0 ? slideContainer.style.left = "-".concat(index * num, "%") : slideContainer.style.left = "13rem";
                  };
                })(i);
              };

              for (var i = 0; i < dots.length && i >= 0; i++) {
                _loop(i);
              }
            };
...
exports.default = _default;
},{"@babel/runtime-corejs3/regenerator":"../node_modules/@babel/runtime-corejs3/regenerator/index.js","@babel/runtime-corejs3/core-js-stable/instance/for-each":"../node_modules/@babel/runtime-corejs3/core-js-stable/instance/for-each.js","@babel/runtime-corejs3/core-js-stable/instance/concat":"../node_modules/@babel/runtime-corejs3/core-js-stable/instance/concat.js","@babel/runtime-corejs3/core-js-stable/instance/map":"../node_modules/@babel/runtime-corejs3/core-js-stable/instance/map.js","@babel/runtime-corejs3/helpers/asyncToGenerator":"../node_modules/@babel/runtime-corejs3/helpers/asyncToGenerator.js"}],"../src/main.js":[function(require,module,exports) {
"use strict";
  ...
  var _ref = (0, _asyncToGenerator2.default)( /*#__PURE__*/_regenerator.default.mark(function _callee() {
    return _regenerator.default.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.t0 = document.querySelector('body');
            _context.next = 3;
          ...
          case 3:
            ...
            _context.next = 7;
            return (0, _navbar.default)();

          case 7:
            _context.next = 9;
            return (0, _carousel.default)();
...
app();
},{"@babel/runtime-corejs3/regenerator":"../node_modules/@babel/runtime-corejs3/regenerator/index.js","@babel/runtime-corejs3/helpers/asyncToGenerator":"../node_modules/@babel/runtime-corejs3/helpers/asyncToGenerator.js","./App":"../src/App.js","./navbar":"../src/navbar.js","./carousel":"../src/carousel.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
